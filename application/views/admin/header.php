...
<html>
<head>
<title>E-Library Fakultas Ilmu Politik</title>
	...
	<nav class="navbar navbar-default">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo base_url().'admin'; ?>">E-Library FISIP</a>
			</div>
			<div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li><a href="<?php echo base_url().'admin/mobil'; ?>"><span class="glyphicon glyphicon-list-alt" ></span> Data Berkas </a></li>
					<li><a href="<?php echo base_url().'admin/pelanggan'; ?>"><span class="glyphicon glyphicon-user"></span> Data Mahasiswa </a></li>
					
					<li><a href="<?php echo base_url().'admin/laporan'; ?>"><span class="glyphicon glyphicon-list-alt"></span> Rekap </a></li>
				</ul>
