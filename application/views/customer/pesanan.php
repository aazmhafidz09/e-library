				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="<?php echo base_url()?>rental/home">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="<?php echo base_url()?>rental/pesanan"> pesanan</a></p>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-70 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Daftar Pesanan</h1>
								<p>kami disini yang senantiasa memberikan pelayanan kepada anda</p>
							</div>
						</div>
					</div>			
					...
					<table class="table">
								...
								$no = 1; 
								 ...
								 foreach ($pesan as $psn)  : ?>  
									<tr>
										<td><?php echo $no ++ ?></td>
										<td><?php echo $psn ['id_mobil'] ?></td>
										<td><?php echo $psn ['qty'] ?></td>
										<td><?php echo $psn ['id_customer'] ?></td>
										<td><?php echo $psn ['tgl_sewa'] ?></td>
										<td><?php echo $psn ['tgl_kembali'] ?></td>
										<td><?php echo $psn ['total_bayar'] ?></td>
									</tr>
